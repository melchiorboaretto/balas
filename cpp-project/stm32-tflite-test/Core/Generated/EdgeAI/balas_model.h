/**
  ...
  ******************************************************************************
  */
#ifndef AI_BALAS_MODEL_H
#define AI_BALAS_MODEL_H

#include "balas_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_BALAS_MODEL_MODEL_NAME          "balas_model"
#define AI_BALAS_MODEL_ORIGIN_MODEL_NAME   "model_quant"

/******************************************************************************/
#define AI_BALAS_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_BALAS_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_BALAS_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_BALAS_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_BALAS_MODEL_IN \
  ai_balas_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_BALAS_MODEL_IN_SIZE { \
  AI_BALAS_MODEL_IN_1_SIZE, \
}
#define AI_BALAS_MODEL_IN_SIZE_BYTES { \
  AI_BALAS_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_BALAS_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_BALAS_MODEL_IN_1_HEIGHT      (32)
#define AI_BALAS_MODEL_IN_1_WIDTH       (32)
#define AI_BALAS_MODEL_IN_1_CHANNEL     (3)
#define AI_BALAS_MODEL_IN_1_SIZE        (3072)
#define AI_BALAS_MODEL_IN_1_SIZE_BYTES  (3073)

/******************************************************************************/
#define AI_BALAS_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_BALAS_MODEL_OUT \
  ai_balas_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_BALAS_MODEL_OUT_SIZE { \
  AI_BALAS_MODEL_OUT_1_SIZE, \
}
#define AI_BALAS_MODEL_OUT_SIZE_BYTES { \
  AI_BALAS_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_BALAS_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_BALAS_MODEL_OUT_1_CHANNEL     (10)
#define AI_BALAS_MODEL_OUT_1_SIZE        (10)
#define AI_BALAS_MODEL_OUT_1_SIZE_BYTES  (10)

/******************************************************************************/
#define AI_BALAS_MODEL_N_NODES (20)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup balas_model
 ...
 * @ref ai_balas_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_balas_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_balas_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_balas_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_BALAS_MODEL_*
 * defines into file @ref balas_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_balas_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_BALAS_MODEL_H */
